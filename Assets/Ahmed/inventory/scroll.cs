...
namespace UnityEngine.UI
{
    ...
    /// </remarks>
    public class scroll : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        /// <summary>
...
#pragma warning restore 649
        ...
        public virtual void OnDrag(PointerEventData eventData)
        {
            ...
            if (result.Count >1  && result[0].gameObject.CompareTag("panel"))
            {
